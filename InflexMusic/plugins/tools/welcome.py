...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("InflexMusic/assets/InflexMusicNwel.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((835, 839))
    draw = ImageDraw.Draw(background)
    font_large = ImageFont.truetype('InflexMusic/assets/ArialReg.ttf', size=65)
    font_small = ImageFont.truetype('InflexMusic/assets/ArialReg.ttf', size=60)
